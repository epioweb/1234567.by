...
while ($arItems = $dbBasketItems->GetNext())
{
    ...
    $dbAddProps = CIBlockElement::GetList(array(), array("ID"=>$arItems["PRODUCT_ID"]), false, false, array("DETAIL_PICTURE", "PROPERTY_CML2_LINK", "DETAIL_PAGE_URL"));
    if ($arAddProps = $dbAddProps->GetNext())
	{
        $arItems["DETAIL_PAGE_URL"] = $arAddProps["DETAIL_PAGE_URL"];
