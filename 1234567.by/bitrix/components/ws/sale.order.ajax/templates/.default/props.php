...
function PrintPropsForm($arSource=Array(), $locationTemplate = ".default")
{
	if (!empty($arSource))
	{
        ...
        <?if('Служебные данные' == $arProperties["GROUP_NAME"]){$isHidden = true;}else{ $isHidden = false;}?>
        <div <?if($isHidden): echo 'style="display:none"'; endif;?> >
            <label>
                <?=$arProperties["NAME"] ?>
...
<?
//printAdmin($arResult["ORDER_PROP"]["USER_PROPS_Y"]);
