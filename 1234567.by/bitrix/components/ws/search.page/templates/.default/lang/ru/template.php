...
$MESS ['MAKE_BASKET_ORDER'] = "Оформить";
$MESS ['EMPTY_STRING'] = "Пустой поисковый запрос. Введите критерий поиска";
$MESS ['SEARCH_MESSAGE'] = "Вы искали <b>#WORD#</b>. Найдено товаров: #CNT#";
?>
